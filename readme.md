...
* ☀️ **Protection anti-chaleur progressive & Filtrage d'Azimut** : La protection solaire ne s'active que si le soleil est physiquement orienté vers les façades ciblées (Azimut entre **85° et 240°**, soit de ~09h00 à ~16h45 avec marge de sécurité, et élévation $\ge 10^\circ$). Dès 16h45, lorsque le soleil passe derrière la maison, les volets **s'ouvrent automatiquement à 100%** pour profiter de la lumière.
